...
if __name__ == "__main__":
    ...
    X, y, all_classes = get_data('traindata500k.csv')
    ...
    sss = StratifiedShuffleSplit(n_splits = 10,test_size = 0.1)#训练集额和测试集的比例随机选定，训练集和测试集的比例的和可以小于1,但是还要保证训练集中各类所占的比例是一样的
